// Embedded cleanup_env.c source code.
// This is compiled at bundle time by gcc to produce cleanup_env.so.
// Keep in sync with cleanup_env.c in the repository root.

export const CLEANUP_ENV_C = `\
/*
